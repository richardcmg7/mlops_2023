...
def run_register_model(data_path: str, top_n: int):
    ...
    for run in runs:
        ...
        # Check if this run has the lowest test RMSE so far
        if run.data.metrics["rmse"] < lowest_test_rmse:
            lowest_test_rmse = run.data.metrics["rmse"]
            best_run = run
    ...
    if best_run:
        ...
        registered_model = mlflow.register_model(
            model_uri, "Best Random Forest Model")
